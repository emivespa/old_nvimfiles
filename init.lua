...
require('lazy').setup({
	{ -- colorscheme
		...
		config = function()
			vim.cmd([[
				augroup xx | autocmd! | augroup END
				function! CustomHighlights()
					highlight ColorColumn              ctermbg=8
					highlight Cursorline    cterm=NONE ctermbg=8             term=NONE
					highlight NonText       cterm=NONE            ctermfg=8
					highlight Search        cterm=NONE ctermbg=10 ctermfg=0
					highlight Specialkey    cterm=NONE            ctermfg=7
					highlight Visual        cterm=NONE ctermbg=4  ctermfg=15
				endfunction
				" call CustomHighlights()
				autocmd xx Colorscheme * call CustomHighlights()
			]])
	...
	-- end simple stuff, start complex stuff ---------------------------------------
